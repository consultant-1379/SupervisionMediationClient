 ...
 *
 */
public class PMImpl extends ManagedObjectImpl implements Serializable {
	private static final long serialVersionUID = 3462291898271803784L;

	public PMImpl(final String name, final String type,
		...
		if (parent == null) {
			throw new DataPersistenceException(
					new IllegalArgumentException(
							"The parent of a PM node must have a non-null parent"));
		} else {
	...
	protected List<AttributeInfo> getExpectedAttributeInfo() {
		...
		/** TODO :: need to add the attributes of PM Node **/
