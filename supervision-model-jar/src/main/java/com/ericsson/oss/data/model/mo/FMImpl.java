 ...
 *
 */
public class FMImpl extends ManagedObjectImpl implements Serializable {
	private static final long serialVersionUID = -2642186581632545422L;

	public FMImpl(final String name, final String type,
		...
		if (parent == null) {
			throw new DataPersistenceException(
					new IllegalArgumentException(
							"The parent of a FM node must have a non-null parent"));
		} else {
	...
	protected List<AttributeInfo> getExpectedAttributeInfo() {
		...
		/** TODO :: need to add the attributes of FM Node **/
